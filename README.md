...
[![run-tests](https://github.com/tootootltd/azure-text-analytics/actions/workflows/run-tests.yml/badge.svg)](https://github.com/tootootltd/azure-text-analytics/actions)
